...
def login():
    if request.method == 'POST':
        ...
        with open('users/userDB.json', 'r') as file:
            data = json.load(file)
        ...
        flash("User or password not found", "error")
        session.pop('show_forgot', None)
        return redirect(url_for('login'))
    
    show_forgot = session.pop('show_forgot', False)
...
def register():
    if request.method == 'POST':
        ...
        with open('users/userDB.json', "w") as file:
